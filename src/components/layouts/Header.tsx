...
export default function Header(props: { className?: string }) {
    return (
        <div className={cn('fixed top-0 flex justify-center items-center w-full', props.className)}>
            <div className="flex h-fit w-full max-w-[650px] items-center justify-between gap-0.5 rounded-md border border-background bg-background p-2 backdrop-blur-sm sm:justify-between">
